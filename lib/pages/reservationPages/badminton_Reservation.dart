...
class BadmintonReservations extends StatefulWidget {
  const BadmintonReservations({Key? key}) : super(key: key);

  @override
  State<BadmintonReservations> createState() => _BadmintonReservationsState();
}

class _BadmintonReservationsState extends State<BadmintonReservations> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(
              'assets/images/badmintonReservation_Equipment.jpeg',
