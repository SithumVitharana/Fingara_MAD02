...
class SquashReservations extends StatefulWidget {
  const SquashReservations({Key? key}) : super(key: key);

  @override
  State<SquashReservations> createState() => _SquashReservationsState();
}

class _SquashReservationsState extends State<SquashReservations> {
    ...
    return Scaffold(
      body: SingleChildScrollView(
        child: Column(
          children: [
            Image.asset(
              'assets/images/squashReservation_Equipment.jpg',
